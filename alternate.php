            ...
            <div class="container">
                <div class="col-container">
                    <div class="logo-col text-center">
                        <a href="<?php print $home_link ?>"><img class="conference-logo" src="/img/ASCE_logo_white.png" /></a>
                    </div>
                    <div class="auto-col">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane active" id="yearpresent">
                ...
                <div class="row details">
                    <div class="container">
                        <div class="col-container">
                            <div class="logo-col hidden-xs text-center"><img class="conference-logo" src="/img/ASCE_logo_white.png"/></div>
                            <div class="auto-col">
                                ...
                                <div class="pull-left col-xs-2 visible-xs"><img class="conference-logo" src="/img/ASCE_logo_white.png"/></div>
